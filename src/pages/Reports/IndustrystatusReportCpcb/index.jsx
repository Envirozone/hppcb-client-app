...
const IndustrystatusReportCpcb = () => {
    ...
    (async () => {
      try {
        const result = await axios(
          `${
            window.apiURL
          }/industries_status/industry_status_report?searchStr=${searchStr}&show_to_CPCB=true&status_CPCB=${btnTxt.toLowerCase()}&state=${"Himachal Pradesh"}&`
        );
      ...
      <PageWrapper>
        <div className="col-12">
          <div className="d-flex justify-content-between">
            <div>
              <PageHeading txt={"CPCB Industry status report"} />
            </div>
          </div>
        </div>
        <div className="col-12">
...
export default IndustrystatusReportCpcb;
