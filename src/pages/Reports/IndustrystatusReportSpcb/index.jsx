...
const IndustrystatusReportSpcb = () => {
    ...
    (async () => {
      try {
        const result = await axios(
          `${
            window.apiURL
          }/industries_status/industry_status_report?searchStr=${searchStr}&show_to_PCB=true&status_SPCB=${btnTxt.toLowerCase()}&state=${"Himachal Pradesh"}&`
        );
      ...
      <PageWrapper>
        <div className="col-12">
          <div className="d-flex justify-content-between">
            <div>
              <PageHeading txt={"SPCB Industry status report"} />
            </div>
          </div>
        </div>
        <div className="col-12">
                  ...
                  <div className="col-12 ">
                    <div className="d-flex justify-content-between ">
                      <div  className="d-flex align-items-center"  style={{ maxWidth: "350px" }}>
                        ...
                        <div className="ps-3">
                          <p className="fs-5" style={{fontWeight:600}}>List : {tableRows}</p>
                        </div>
                      </div>
                      <div>
                            ...
                            <li>
                              <span
                                ...
                                onClick={() => {
                                  if (btnTxt !== "Delay") {
                                    // setUrl(
                                    //   `${window.apiURL}/industries_status/industry_status_report?show_to_PCB=true&status_SPCB=delay`
                                    // );
                                    setBtnTxt("Delay");
                                  }
                                }}
...
export default IndustrystatusReportSpcb;
